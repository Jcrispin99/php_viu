...
$nombreCompleto = htmlspecialchars($actor->getNombre() . ' ' . $actor->getApellidos());
...
<div class="container mt-4">
    <div class="card border-danger">
        ...
        <div class="card-body">
            <h5>¿Estás seguro de eliminar al actor <strong>"<?= $nombreCompleto ?>"</strong>?</h5>
            
            <?php if ($seriesCount > 0): ?>
                <div class="alert alert-warning mt-3">
                    <h6><i class="bi bi-exclamation-circle me-2"></i>¡Atención!</h6>
                    <p class="mb-2">
                        Este actor participa en <strong><?= $seriesCount ?></strong> serie(s). Se eliminará su participación de:
                    </p>
                    <ul class="mb-0">
