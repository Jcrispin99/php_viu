...
$nombreCompleto = htmlspecialchars($director->getNombre() . ' ' . $director->getApellidos());
$pageTitle = "Confirmar eliminación - " . $nombreCompleto;
ob_start();
?>
...
<div class="container mt-4">
    <div class="card border-danger">
        ...
        <div class="card-body">
            <h5>¿Estás seguro de eliminar al director <strong>"<?= $nombreCompleto ?>"</strong>?</h5>
            
            <?php if ($seriesCount > 0): ?>
                <div class="alert alert-warning mt-3">
                    <h6><i class="bi bi-exclamation-circle me-2"></i>¡Atención!</h6>
                    <p class="mb-2">
                        Este director tiene <strong><?= $seriesCount ?></strong> serie(s) asociada(s) que también serán <strong>eliminadas</strong>:
                    </p>
                    <ul class="mb-0">
            ...
            <?php else: ?>
                <div class="alert alert-info mt-3">
                    ...
                    Este director no tiene series asociadas.
                </div>
            <?php endif; ?>
